...
namespace ASP_P26.Migrations
{
    ...
    [Migration("20250902160628_CartAndItems")]
    partial class CartAndItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_P26.Data.Entities.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_P26.Data.Entities.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_P26.Data.Entities.Cart", b =>
                {
                    b.HasOne("ASP_P26.Data.Entities.UserData", "User")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("ASP_P26.Data.Entities.CartItem", b =>
                {
                    b.HasOne("ASP_P26.Data.Entities.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP_P26.Data.Entities.Product", "Product")
                        .WithMany()
